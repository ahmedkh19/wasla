...
@endphp
<html dir="rtl" lang="ar" data-textdirection="{{ env('MIX_CONTENT_DIRECTION') === 'rtl' ? 'rtl' : 'ltr' }}" class="{{ ($configData['theme'] === 'light') ? '' : $configData['layoutTheme'] }}">
...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/logo/' . FAVICON_FILE_NAME)}}">
